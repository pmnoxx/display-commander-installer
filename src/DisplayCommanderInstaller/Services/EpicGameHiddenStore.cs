...
/// <summary>Persisted hidden Epic titles (stable keys) — excluded from All / Favorites / RenoDX until unhidden.</summary>
public sealed class EpicGameHiddenStore
{
    ...
    public bool IsHidden(string stableKey)
    {
