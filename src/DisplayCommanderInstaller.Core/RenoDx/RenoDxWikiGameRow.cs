...
public sealed class RenoDxWikiGameRow
{
    ...
    /// <summary>clshortfuse GitHub Pages <c>.addon32</c>/<c>.addon64</c> URL when present; otherwise the row is still wiki-listed but in-app download is not offered.</summary>
